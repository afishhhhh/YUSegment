#
#  Be sure to run `pod spec lint YUSegment.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "afishhhhh"
  # s.authors            = { "afishhhhh" => "ygqdev0126@gmail.com" }
  # s.social_media_url   = "http://twitter.com/afishhhhh"
  ...
  s.source       = { :git => "https://github.com/afishhhhh/YUSegment.git", :tag => "0.1.0" }
